          ...
          <WallOfText>
            ...
            <Collapse in={showIntro === "intro"}>
              <div>
                <p>
                  ...
                  quite feel like I wanted to pursue a career in that field, so
            ...
            <Collapse in={showIntro === "experience"}>
              <div>
                <p>
                  ...
                  full stack bootcamp and things kinda just took off from there.
                  As far as my skills in programming go - it's mostly in the
                  context of web development. i.e. for loops and arr.map() are
                  my jam and I'd have more failed submissions than correct ones
                  in leetcode because I didn't know what hash tables or linked
                  lists were. I'm getting there, and I'm having loads of fun on
                  the way!
                </p>
              </div>
            </Collapse>
            <Collapse in={showIntro === "language"}>
              <div>
                ...
                <p>
                  I learnt German in Goethe Institut up to B1 level, but that's
                  in 2016 - also habe ich meine Deutsch meistens vergessen.
                </p>
                <p>
                ...
                <p>
                  ...
                  decent Louis Armstrong impression when singing What a
